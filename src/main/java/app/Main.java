 ...
 * которые определяли бы корректные для них значения и вычисляли бы,
 * но это было бы очень хлопотно.
 * К тому же, значения чисел везде одни и те же,
 * поэтому, оптимальнее будет сделать один калькулятор,
 * который по понятным ему числам и строковому оператору вычислить значение,
